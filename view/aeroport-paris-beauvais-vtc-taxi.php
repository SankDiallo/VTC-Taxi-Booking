<?php 
$data_site['title'] = 'Réservez un chauffeur privé VTC aéroport de Paris Beauvais Tillé, moins cher qu\'un taxi.';
include 'header.php' ;
?>
...
<div class="w3-padding-64 w3-white">
    ...
    <h1 class="w3-xxlarge w3-text-dark-grey"> Réservez votre chauffeur VTC, mieux qu'un taxi vers ou depuis l'aéroport de Paris Beauvais</h1>
    </div>
  <div class="w3-row-padding">
      <div class="w3-col l8 m6 w3-center">
      <h2 class="w3-xxlarge w3-text-dark-grey"><b>Forfait Aéroport</b></h2>
      <h3 class="w3-xlarge w3-text-green">Transfert entre Paris et l'aéroport de Beauvais en VTC</h3>
      <p class="w3-large w3-text-dark-grey">Votre chauffeur VTC vous assure vos transferts vers l’aéroport de Paris Beauvais dès 119.90 €.<br />
        Réservation facile. Transfert aéroport moins cher qu'un taxi! Prix fixe, 4 passagers et bagages inclus.
    Si vous arrivez à l'aéroport de Beauvais, votre chauffeur vous récupère au point de rdv et s'occupe de vos sacs et bagages. N'attendez plus et réservez votre chauffeur privé pour vos transferts Paris – Beauvais.</p>
...
Cependant si vous devez récupérer des bagages enregistrés ou si vous venez d'une destination non Européenne, prévoyez plus de temps. Nous vous conseillons d'ajouter un délai d'attente supplémentaire de 20 à 45 minutes sans oublier de renseigner votre numéro de vol.</p>
      <p class="w3-large">Temps de trajet vers l'aéroport de Beauvais : environ 2h30 aux heures de pointes et 2h hors heures de pointes</p>
