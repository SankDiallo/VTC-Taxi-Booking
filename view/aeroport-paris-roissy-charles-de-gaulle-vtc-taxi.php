<?php 
$data_site['title'] = 'Réservez un chauffeur privé VTC aéroport de Paris Roissy CDG (Charles de Gaulle), moins cher qu\'un taxi.';
include 'header.php' ;
?>
...
<div class="w3-padding-64 w3-white">
    ...
    <h1 class="w3-xxlarge w3-text-dark-grey"> Réservez votre chauffeur VTC, mieux qu'un taxi vers ou depuis l'aéroport de Paris Roissy CDG</h1>
    </div>
  <div class="w3-row-padding">
      <div class="w3-col l8 m6 w3-center">
      <h2 class="w3-xxlarge w3-text-dark-grey"><b>Forfait Aéroport</b></h2>
      <h3 class="w3-xlarge w3-text-green">Transfert entre Paris et l'aéroport Roissy CDG en VTC</h3>
      <p class="w3-large w3-text-dark-grey">Votre chauffeur VTC vous assure vos transferts de Paris vers l’aéroport de Roissy CDG dès 49.90 €.<br />
        Réservation facile. Transfert aéroport moins cher qu'un taxi! Prix fixe, 4 passagers et bagages inclus.
    Si vous arrivez à l'aéroport de Roissy CDG, votre chauffeur vous récupère au point de rdv et s'occupe de vos sacs et bagages. N'attendez plus et réservez votre chauffeur privé pour vos transferts Paris – Roissy Charles de Gaulle.</p>
...
Cependant si vous devez récupérer des bagages enregistrés ou si vous venez d'une destination non Européenne, prévoyez plus de temps. Nous vous conseillons d'ajouter un délai d'attente supplémentaire de 20 à 45 minutes sans oublier de renseigner votre numéro de vol.</p>
      <p class="w3-large">Temps de trajet vers l'aéroport de Roissy CDG : environ 1h30 aux heures de pointes et 1h hors heures de pointes</p>
